...
// (MIT, Grafana Labs). The CDN is flaky in our CI runners
// (Load Smoke job has been failing intermittently with both DNS
// resolution and TCP connect timeouts to 216.40.34.41), so we
// keep a local copy.
//
// To refresh: `curl -fL https://jslib.k6.io/k6-summary/0.0.2/index.js > tests/load/vendor/k6-summary.js`
// then re-prepend this comment block.
